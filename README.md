...
2. (a) W przypadku nowych sesji należy. Założyc nową sesję i w opcji "Optional: Choose a Character Sheet", wybrać "Custom".
2. (b) Jeżeli chcemy dodać karty postaci do instniejącej już sesji należy. Wejśc w opcję sesji a nastepnie w opcji "Character Sheet Template" wybrać "Custom".
